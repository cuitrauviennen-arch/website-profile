...
export interface ApiAwardAward extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team Awards and Certifications';
    displayName: 'Award';
    pluralName: 'awards';
    singularName: 'award';
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Worked Projects Portfolio';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    overview: Schema.Attribute.Component<'project.overview-item', true>;
    phases: Schema.Attribute.Component<'project.phase', true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    spanClass: Schema.Attribute.Enumeration<['span1', 'span2', 'span3']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'span1'>;
